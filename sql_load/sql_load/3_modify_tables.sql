...
COPY company_dim
FROM 'C:\Users\NIRMAL\Data_path\SQL_Project_data_Job_analysis\csv_files\csv_files\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\NIRMAL\Data_path\SQL_Project_data_Job_analysis\csv_files\csv_files\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\NIRMAL\Data_path\SQL_Project_data_Job_analysis\csv_files\csv_files\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\NIRMAL\Data_path\SQL_Project_data_Job_analysis\csv_files\csv_files\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
